...
//        QueAndExc queAndExc = list.get(i);
        ...
        holder.iv_que_body_img1.setImageResource(R.drawable.test);
        holder.iv_que_body_img2.setImageResource(R.drawable.test);
        holder.iv_que_body_img3.setImageResource(R.drawable.test);
